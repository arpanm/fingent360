...
The 20 September follow-up authors Mongo recovery, explicit scheduler outcomes,
reviewed grouping of related releases, offline form-help parity, submitted feedback
context/delivery acceptance, and the full image-generation workflow. These changes
are **not yet validated** and do not inherit the baseline passes below. See the
[follow-up delivery and commands](docs/development/nondeferred-authoring-2026-09-20.md).
No new database migration, dependency or automatic source activation is introduced.
