...
SDLC-REPAIR-005 records the supplied Prettier failure in `scripts/sdlc-impact.mjs` and `scripts/sdlc.mjs`. Repair was blocked by a concurrent source edit; neither script was changed by this attempt. Once writers are stopped, the smallest manual validation is `pnpm exec prettier --check scripts/sdlc-impact.mjs scripts/sdlc.mjs`. No validation or commit was performed. See [repair acceptance](docs/development/sdlc.md#sdlc-repair-005--concurrent-edit-blocker).
...
Complete Indian equity history, the five named broker export parsers, broad causal/rebalance policies, all release calendars/original numerical vintages and fund look-through/bond market coverage remain distinct pending requirements. Generic mapped imports and normalized evidence ingestion are not labelled complete source adapters.
...
|     2 | SRC-002 | P0       | Indian EOD prices/volume        | NSE/BSE EOD reports                                      | NSE/BSE licensed EOD feed                      | NSE UDiFF price parser/fetch/review authored               | Validate dated official ZIP and usage permission; broader exchange/adjusted-history coverage remains pending                            | Yes         |
|     3 | SRC-003 | P0       | Corporate actions               | NSE/BSE + issuer filings                                 | Exchange corporate-data feed; LSEG/FactSet     | Versioned normalized evidence workflow authored            | Verified exchange corporate-action parser, rights and adjusted-price reconstruction remain pending                                      | Yes         |
...
|     5 | SRC-005 | P0       | Reported fundamentals           | Filing/XBRL extraction                                   | Capitaline/ACE/CMIE                            | Fundamental observation model/storage authored             | Implement verified filing/XBRL extraction and representative company reconciliation; normalized imports do not complete source coverage | Yes         |
|     6 | SRC-006 | P0       | Index/sector data               | NSE Indices/BSE Indices                                  | Licensed index feed                            | Nifty50 current-constituent CSV adapter authored           | Validate rights/live file; historical constituents, classifications and broader index series remain pending                             | Yes         |
|     7 | SRC-007 | P0       | India macro                     | World Bank + PIB; MoSPI/RBI pending                      | CEIC/Macrobond/CMIE                            | Partial adapters + automatic capture authored              | RBI/MoSPI numerical series, verified calendars and original publication vintages remain pending                                         | Yes         |
|     8 | SRC-008 | P0       | Global macro/rates              | FRED, BLS, BEA, Treasury, Fed, ECB                       | Macrobond/Haver/Bloomberg/LSEG                 | Partial adapters + BEA calendar capture authored           | Validate automated capture; broader Fed/BLS calendars and original numerical vintages remain pending                                    | Yes         |
...
|    12 | SRC-012 | P0       | Market/company news             | Primary filings/releases + permitted reputable links     | Reuters/LSEG or Dow Jones/Factiva              | Bounded child                                              | Define link-only/full-text rights and two-source verification policy                                                                    | Yes         |
