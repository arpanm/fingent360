...
Failure excerpt (untrusted; local original has full details):
    ...
    Call log:
      - waiting for getByRole('button', { name: 'Corporate ratings', exact: true })
    ...
    > 23 |   await page.getByRole('button', { name: tab, exact: true }).click();
      ...
      25 |
        ...
        at /Users/arpanmacmini/code/fingent360/tests/e2e/cases/browser/corporate-rating.spec.ts:83:3
