# BUG-588dcf45af255421

- Status: Open
- Case/project: E2E-WEB-1390 / desktop
...
Failure excerpt (untrusted; local original has full details):
    ...
    > 31 |     .selectOption(event.id);
         |      ^
      32 |   await region
      33 |     .getByRole('button', { name: 'Extract BEA GDP vintages', exact: true })
      34 |     .click();
        at /Users/arpanmacmini/code/fingent360/tests/e2e/cases/browser/bea-gdp-scenario.spec.ts:31:6
