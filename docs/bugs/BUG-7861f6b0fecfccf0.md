...
Failure excerpt (untrusted; local original has full details):
    ...
    Call log:
      - waiting for getByRole('button', { name: 'Automatic research', exact: true })
    ...
    > 23 |   await page.getByRole('button', { name: tab, exact: true }).click();
      ...
      25 |
        ...
        at /Users/arpanmacmini/code/fingent360/tests/e2e/cases/browser/commodity-benchmarks.spec.ts:122:5
