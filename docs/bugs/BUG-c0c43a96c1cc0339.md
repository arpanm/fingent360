# BUG-c0c43a96c1cc0339

- Status: Resolved
- Case/project: E2E-WEB-1930 / desktop
- Stories: SRC-003
...
Failure excerpt (untrusted; local original has full details):
    ...
    Call log:
      - waiting for getByRole('button', { name: 'Rights and mergers', exact: true })
    ...
    > 23 |   await page.getByRole('button', { name: tab, exact: true }).click();
      ...
      25 |
        ...
        at /Users/arpanmacmini/code/fingent360/tests/e2e/cases/browser/equity-action-terms.spec.ts:21:5
