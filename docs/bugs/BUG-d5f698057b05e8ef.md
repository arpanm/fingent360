...
Failure excerpt (untrusted; local original has full details):
    ...
    > 166 |     const proposalId = randomUUID();
      ...
      169 |         headers, data: { kind: 'event', target: eventId, body: review },
        ...
        at axisFixture (/Users/arpanmacmini/code/fingent360/tests/e2e/helpers/axis-portfolio-flow.ts:17:16)
        at /Users/arpanmacmini/code/fingent360/tests/e2e/cases/browser/axis-portfolio.spec.ts:13:13
