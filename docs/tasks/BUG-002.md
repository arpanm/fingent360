...
Reviewed scope: Unknown nested API routes return HTTP404 and structured JSON with the correct content type under the normalized prefix; health and readiness remain unchanged. This bounded repair does not complete wider feature parents.
