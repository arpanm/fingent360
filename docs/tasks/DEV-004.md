...
- **Next action / inputs:** Review saved DB-LEAST-PRIVILEGE passes; complete remaining repeated-migration, retained-data and rollback requirements under MIGRATIONS-001.
