...
- **Next action / inputs:** Operating entity, registered/partner model and qualified product-specific approval are unavailable. No answer assumed; see applicability record.
