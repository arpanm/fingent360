...
- **Pending:** Developer: Build action taxonomy and adjusted-price golden tests.
- **Next action / inputs:** Developer: Build action taxonomy and adjusted-price golden tests.
