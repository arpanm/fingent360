...
- **Pending:** Developer: Build filing registry, hash/version and entitlement policy.
- **Next action / inputs:** Developer: Build filing registry, hash/version and entitlement policy.
