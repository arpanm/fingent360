...
- **Pending:** Developer: Select initial financial schema and 25-company validation set.
- **Next action / inputs:** Developer: Select initial financial schema and 25-company validation set.
