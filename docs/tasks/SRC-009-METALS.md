# SRC-009-METALS — Monthly gold silver copper source workflow

- **Status:** Implementation complete; validation pending
- **Parent:** [SRC-009](SRC-009.md). This completed scope does not complete its broader parent.
- **Implemented:** Retained original monthly benchmarks, precise units, independent review, paginated Operations and default-disabled scheduled draft capture.
...
- **Authored acceptance:** API1710–1714, WEB1710–1711, OFFLINE1710. Cases cover the specified behavior, not live provider permissions or physical-device acceptance.
- **Migration:** 104. No dependency added for this child.
...
With the documented database/API/web setup and required migrations, run `pnpm sdlc "Validate SRC-009-METALS" -- --grep "E2E-(API|WEB|OFFLINE)-171[0-4]"`. Use the web URL printed by `pnpm dev`; keep test watch mode off. Check the corresponding Operations/reader flow documented in the parent. Installed Android/iOS bundles require the documented rebuild/reinstall. Report the exact failed case, saved artifact run and error. The user-operated SDLC command owns gated commit and execution.

## Current acceptance review — 20 September 2026

Reviewed scope: Monthly World Bank gold, silver and copper originals, exact units, quarantine, independent publication, paginated history, permission-bound scheduled drafts and downloaded evidence handling. Live source activation and physical-device release certification remain separate. Broader parent coverage is not completed.
