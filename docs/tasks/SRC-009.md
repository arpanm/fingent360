...
- **Pending:** Developer: Define permissible EOD benchmarks and currency conversion rules.
- **Next action / inputs:** Developer: extend beyond current ECB FX and monthly oil series; verify each added benchmark.
