...
- **Pending:** Developer: Define link-only/full-text rights and two-source verification policy.
- **Next action / inputs:** Developer: Define link-only/full-text rights and two-source verification policy.
