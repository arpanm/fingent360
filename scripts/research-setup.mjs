...
if (value) {
  if (!/^[a-f0-9]{64}$/.test(value))
    throw new Error(
      'Existing RESEARCH_ADMIN_TOKEN is invalid; correct it locally. No changes made.',
    );
  ...
  console.log(
    'Research operator key saved in .env; key is not printed. Restart the API to load it.',
  );
}
