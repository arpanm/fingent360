...
test('E2E-WEB-222 populated goal, holding and allocation report keeps exact separate cost @REPORTS-001', async ({
  page,
}) => {
  await page.goto('/');
  await page.evaluate(
  ...
  await page.screenshot({
    path: test.info().outputPath('issued-record-report.png'),
    fullPage: false,
  });
