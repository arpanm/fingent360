...
- IMPACT-TRACE-001 API/WEB1330 and API/WEB/OFFLINE1331: exact causal-review binding, empirical source-bound calibration, owner persistence/export and uncertainty. A statistical association is not a causal forecast; numerical qualification additionally requires admitted adjustment coverage.
